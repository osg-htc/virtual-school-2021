...
In this exercise, you will change the wrapper script and submit file from a previous exercise to use arguments. It builds on [Exercise 2.2](software/part2-ex2-prepackaged) from earlier, so only do this exercise if you've already done Exercise 2.2.
